...
def parse_config(argv=None):
    ...
    parser.add_argument('--use_mobilenet_init', default=False,
                        type=lambda x: x.lower() in ['true', '1'],
                        help='Use MobileNetV3 predictions for initialization')
    parser.add_argument('--mobilenet_ckpt', type=str, default='',
                        help='The path to the MobileNetV3 checkpoint')
